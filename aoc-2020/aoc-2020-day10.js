...
const solveDay10Part1 = (data) => {
  const joltages = generateJoltages(data);
  const diffs = joltages.slice(1).map((joltage, i, arr) => {
...
console.log(solveDay10Part2(testData1));
